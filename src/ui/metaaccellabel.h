...
#define META_ACCEL_LABEL(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST((obj), META_TYPE_ACCEL_LABEL, MetaAccelLabel))
#define META_ACCEL_LABEL_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST((klass), META_TYPE_ACCEL_LABEL, MetaAccelLabelClass))
#define META_IS_ACCEL_LABEL(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE((obj), META_TYPE_ACCEL_LABEL))
#define META_IS_ACCEL_LABEL_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE((klass), META_TYPE_ACCEL_LABEL))
#define META_ACCEL_LABEL_GET_CLASS(obj) \
  (G_TYPE_INSTANCE_GET_CLASS((obj), META_TYPE_ACCEL_LABEL, MetaAccelLabelClass))
