...
typedef enum { META_UI_DIRECTION_LTR, META_UI_DIRECTION_RTL } MetaUIDirection;
...
void meta_ui_update_frame_style(MetaUI *ui, Window window);
...
MetaWindowMenu *meta_ui_window_menu_new(MetaUI *ui, Window client_xwindow,
                                        ...
                                        int n_workspaces,
                                        MetaWindowMenuFunc func, gpointer data);
