...
static void init_prop_value(MetaDisplay *display, Atom property,
                            MetaPropValue *value);
static void reload_prop_value(MetaGroup *group, MetaPropValue *value);
static MetaGroupPropHooks *find_hooks(MetaDisplay *display, Atom property);
...
void meta_group_reload_properties(MetaGroup *group, const Atom *properties,
  ...
  meta_prop_get_values(group->display, group->group_leader, values,
                       n_properties);
...
static void reload_prop_value(MetaGroup *group, MetaPropValue *value) {
  ...
  if (hooks && hooks->reload_func != NULL) (*hooks->reload_func)(group, value);
}

static void init_wm_client_machine(MetaDisplay *display, Atom property,
                                   MetaPropValue *value) {
...
static void init_net_startup_id(MetaDisplay *display, Atom property,
                                MetaPropValue *value) {
